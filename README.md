...
<div style="display: flex; justify-content: center; margin-top: 50px;">
  ...
  ">
    ...
    <img 
      width="48" 
      height="48" 
      src="https://github.com/user-attachments/assets/08b3b127-0aff-410e-ac2e-76bbbea8d718" 
      alt="Image"
    >
  </h1>
</div>
...
/* Estilo da imagem — ajuste width conforme necessário */
.binary-gif__img {
  width: 240px; /* tamanho padrão */
  max-width: 22vw;
  height: auto;
  display: block;
  border-radius: 8px;
...
/* Esconde o GIF em telas pequenas */
